...
<%
		...
		PageBean pages = (PageBean) session.getAttribute("Timequestions");
	...
	<div class="wenda clear">
		<div class="wenda-main fl">
			<div class="nav">
				...
				<a href="time.question?QTindex=1" class="active">最新</a>
			...
			<div class="wenda-list">
				...
				<table class="page_table" border="0" cellspacing="0" cellpadding="0">  
		             <tr>
		               <td width="40" align="right"><a href="time.question?QTindex=1" ><span >首页</span></a></td>
		               <% if(pages.getCurrentPage()>1){ %>
		               <td width="40" align="right"><a href="time.question?QTindex=${QTindexs-1}&ticket=getNewXsgl"> <span >上一页</span></a></td>  
		               <% }%>
		               <% if(pages.getCurrentPage()==1){ %>
		               <td width="40" align="right"><a href="time.question?QTindex=1&ticket=getNewXsgl"><span >上一页</span></a></td>  
		               <% }%>
		               ...
		               <td width="40" align="left"><a href="time.question?QTindex=${QTindexs+1}&ticket=getNewXsgl"  ><span >下一页</span></a></td>  
		               <%} %>
		               <% if(pages.getCurrentPage()==pages.getPageTotal()){ %>
		               <td width="40" align="left"><a href="time.question?QTindex=<%=pages.getPageTotal() %>&ticket=getNewXsgl"><span  >下一页</span></a></td>  
		               <%} %>
		               <td width="40" align="left"><a href="time.question?QTindex=<%=pages.getPageTotal() %>&ticket=getNewXsgl"><span >尾页</span></a></td>
		             </tr>
		        </table>
			</div>
		</div>
				...
				<%if(interests.equals("0")==false) {%>
			        <div class="user-pic">
			            <a href="/u/1301488/bbs">
			                <img src="<%=basePath %>/user/head/${user.head}"alt="">
			            </a>
			        </div>
			        <div class="user-name">
